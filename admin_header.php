<header class="header">
   ...
   <nav class="navbar">
      ...
      <a href="post_property.php"><span><i class="fa-solid fa-building"></i>property</span></a>
      <a href="requests.php"><span><i class="fa-solid fa-rectangle-list"></i>requests</span></a>
   </nav>
